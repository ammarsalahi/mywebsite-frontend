  ...
  return (
    <div>
      <div className='px-3 pt-24'>
        <button 
            className={settings=="profile"?'btn-blue nav-selected':'nav-unselected'} 
            onClick={handleSettingsChanges("profile")}
        >
            <ImProfile />
           {t('set1')} 
        </button>
        <button 
            className={settings=="password"?'btn-blue nav-selected':'nav-unselected'} 
        ...
        <button 
          className={settings=="otp"?'btn-blue nav-selected':'nav-unselected'}

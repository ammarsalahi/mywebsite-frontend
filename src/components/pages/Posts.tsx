...
import { filterSelector, langSelector, pageLoadSelector, postSearchSelector, themeSelector } from '../states/Selectors'
     ...
     <div className='paddingtop'>
        ...
        <div className={`card-${theme} border-2 border-blue-500 rounded-full`}>
            <div className="p-1 flex gap-0">
              <label className="input input-ghost input-sm w-96 lg:w-[650px] border-0 rounded-full flex items-center gap-2" dir={t('dir')}>
                <AiOutlineSearch className='text-2xl '/>
                <input type="text" className="grow" placeholder={t('search')} dir={t('dir')}
        ...
        <div className='category-show py-4'>
            ...
            {categories.length>0 &&<div className="flex flex-wrap justify-center gap-3 pt-3 " dir={t('dir')}>
        ...
        <div className={theme=="dark"?"modal-box py-3 bg-black":"modal-box py-3 bg-gray-400"}>
          <div className="flex justify-end ps-5 items-center">
            ...
            <p className='text-2xl mb-4 text-center font-semibold'>{t("postsearch")}</p>
              <label className="input input-bordered  w-full rounded-2xl flex items-center gap-2" dir={t("dir")}>
                <AiOutlineSearch className='text-2xl '/>

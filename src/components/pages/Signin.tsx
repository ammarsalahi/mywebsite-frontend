          ...
          >
            <div className="card-body p-0">
              <div className="grid lg:grid-cols-2 px-0">
                    ...
                    >
                      {({
                        ...
                        <form onSubmit={handleSubmit}>
                          <div className="mb-6">
                            <label className="input input-bordered flex items-center rounded-2xl gap-2">
                              ...
                              <input
                                ...
                                placeholder={t("signuser")}
                              />
                            </label>
                            {errors.username && (
                              <div className="label">
                                <div className="label-alt text-red-500">
                          ...
                          <button
                            type="submit"
                            className="btn-blue w-full hover:w-full rounded-2xl text-lg font-semibold"
                          >
                            {t("signbtn")}
                            <FaCheck />
                          </button>
                ...
                <div className="hidden md:flex justify-center items-center h-100 bg-blue-500 border border-blue-500 rounded-e-2xl">
                  <Link to={"/"}>
                    <motion.img
                      src={lightIcon}
